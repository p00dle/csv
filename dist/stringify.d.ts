...
export declare function stringifyCsv<T extends Record<string, any>>(arr: T[], columns?: CsvColumns<T>, options?: CsvParams): string;
...
export declare function createStringifyCsvTransformStream<T extends Record<string, any>>(columns?: CsvColumns<T>, options?: CsvParams): Transform;
