...
class CsvParser {
    constructor(isStream, columns, options) {
        ...
        const { delimiter, rowSeparator, quote, escapeQuote, useNullForEmpty, dateClass, dateOptions, dateFormats } = (0, utils_1.normalizeOptions)(options);
    ...
    initiate() {
        try {
            ...
            const parsersByType = (0, utils_1.parsersByTypeFactory)(this.dateClass, this.dateOptions, this.dateFormats);
