...
export declare function parsersByTypeFactory(DateClass: DateConstructor, dateOptions: CsvOptions['dateOptions'], dateFormats: CsvOptions['dateFormats']): ParsersByType;
export declare function stringifyersByTypeFactory(DateClass: DateConstructor, dateOptions: CsvOptions['dateOptions'], dateFormats: CsvOptions['dateFormats']): StringifyersByType;
